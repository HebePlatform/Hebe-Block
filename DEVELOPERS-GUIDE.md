...
### Usable URLs ###
  ...
  - **API** - http://localhost:8082/test
  - **DB Interface** - http://localhost:8082/dbshell
  - **Java Class Browser** - http://localhost:8082/doc

### Database ###
  
  - H2 embedded database
  - main database: `hebe_db/`
  - test database: `hebe_test_db/`
  ...
  - use the hebe.db framework when accessing the database from your code
...
### Testing ###
  ...
  - all API calls can be tested manually from the auto-generated http://localhost:8082/test page
...
- https://crowdin.com/project/hebe-ui-translation
...
The HEBE wallet UI run as a mobile app.
...
6. Under the <HEBERoot>\mobile\app folder execute the command:
createapp.bat
