...
import hebe.http.EventListener.PendingEvent;
 ...
 * hebe.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than hebe.apiEventTimeout.</li>
 * </ul>
 *
