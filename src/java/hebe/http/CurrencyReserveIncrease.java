...
/**
 * Increase the value of currency units by paying HEBE
 * <p>
 * Parameters
 * <ul>
 ...
 * Constraints
 * <p>
 * This API is allowed only when the currency is {@link hebe.CurrencyType#RESERVABLE} and is not yet active.
 * <p>
 ...
 * The list of founders and their NQT investment can be obtained using the {@link hebe.http.GetCurrencyFounders} API.
 */
