...
import static hebe.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static hebe.http.JSONResponses.UNKNOWN_ACCOUNT;
import static hebe.http.JSONResponses.incorrect;
 ...
 * <p>
 * A funding monitor will transfer HEBE, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * HEBE amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  HebeException        Unable to process request
     */
    @Override
