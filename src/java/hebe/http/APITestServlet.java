...
public class APITestServlet extends HttpServlet {
    ...
    private static final String header1 =
            ...
            "           <a class='navbar-brand' href='/test'>HEBE http API</a>\n" +
            "       </div>\n" +
            ...
            "               <li><a href='https://hebewiki.org/wiki/The_Hebe_API' target='_blank' style='margin-left:20px;'>Wiki Docs</a></li>\n" +
            "           </ul>\n" +
            "       </div>\n" +
            "   </div>\n" +
            "</div>\n" +
    ...
    private static String form(HttpServletRequest req, String requestType, boolean singleView, APIServlet.APIRequestHandler requestHandler) {
        ...
        buf.append("<a style='font-weight:normal;font-size:14px;color:#777;' href='https://hebewiki.org/wiki/The_Hebe_API#");
        ...
        String formAction = "/test-proxy".equals(path) ? "/hebe-proxy" : "/hebe";
