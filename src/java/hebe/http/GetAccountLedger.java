 ...
 * account ledger tracks all account changes as determined by the hebe.ledgerAccounts,
 * hebe.ledgerLogUnconfirmed and hebe.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than hebe.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the hebe.maxAPIRecords property
 ...
 *     <tr>
 *       <td>HEBE_BALANCE</td>
 *       <td>Change in the HEBE balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_HEBE_BALANCE</td>
 *       <td>Change in the unconfirmed HEBE balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  HebeException        Invalid request
     */
    @Override
