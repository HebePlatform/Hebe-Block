...
public interface Attachment extends Appendix {
    ...
    abstract class AbstractAttachment extends Appendix.AbstractAppendix implements Attachment {
        ...
        @Override
        final void validate(Transaction transaction) throws HebeException.ValidationException {
        ...
        final int getFinishValidationHeight(Transaction transaction) {
            return isPhased(transaction) ? transaction.getPhasing().getFinishHeight() - 1 : HEBE.getBlockchain().getHeight();
        }
    ...
    final class MessagingAliasAssignment extends AbstractAttachment {
        ...
        MessagingAliasAssignment(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAliasSell extends AbstractAttachment {
        ...
        MessagingAliasSell(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAliasBuy extends AbstractAttachment {
        ...
        MessagingAliasBuy(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
        }
    ...
    final class MessagingAliasDelete extends AbstractAttachment {
        ...
        MessagingAliasDelete(final ByteBuffer buffer, final byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
        }
    ...
    final class MessagihebeollCreation extends AbstractAttachment {
        ...
        public final static class PollBuilder {
            ...
            public MessagihebeollCreation build() {
                return new MessagihebeollCreation(this);
            }
        }
        ...
        MessagihebeollCreation(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
            ...
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new HebeException.NotValidException("Invalid number of poll options: " + numberOfOptions);
            }
        ...
        MessagihebeollCreation(JSONObject attachmentData) {
            super(attachmentData);
        ...
        private MessagihebeollCreation(PollBuilder builder) {
    ...
    final class MessagingVoteCasting extends AbstractAttachment {
        ...
        public MessagingVoteCasting(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
            pollId = buffer.getLong();
            int numberOfOptions = buffer.get();
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new HebeException.NotValidException("More than " + Constants.MAX_POLL_OPTION_COUNT + " options in a vote");
            }
    ...
    final class MessagihebehasingVoteCasting extends AbstractAttachment {

        private final List<byte[]> transactionFullHashes;
        private final byte[] revealedSecret;

        MessagihebehasingVoteCasting(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
            ...
            if (secretLength > Constants.MAX_PHASING_REVEALED_SECRET_LENGTH) {
                throw new HebeException.NotValidException("Invalid revealed secret length " + secretLength);
            }
            if (secretLength > 0) {
        ...
        MessagihebehasingVoteCasting(JSONObject attachmentData) {
            super(attachmentData);
        ...
        public MessagihebehasingVoteCasting(List<byte[]> transactionFullHashes, byte[] revealedSecret) {
    ...
    final class MessagingHubAnnouncement extends AbstractAttachment {
        ...
        MessagingHubAnnouncement(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
            this.minFeePerByteNQT = buffer.getLong();
            int numberOfUris = buffer.get();
            if (numberOfUris > Constants.MAX_HUB_ANNOUNCEMENT_URIS) {
                throw new HebeException.NotValidException("Invalid number of URIs: " + numberOfUris);
            }
        ...
        MessagingHubAnnouncement(JSONObject attachmentData) throws HebeException.NotValidException {
            super(attachmentData);
            ...
            try {
                ...
                throw new HebeException.NotValidException("Error parsing hub terminal announcement parameters", e);
            }
        }
    ...
    final class MessagingAccountInfo extends AbstractAttachment {
        ...
        MessagingAccountInfo(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAccountProperty extends AbstractAttachment {
        ...
        MessagingAccountProperty(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ColoredCoinsAssetIssuance extends AbstractAttachment {
        ...
        ColoredCoinsAssetIssuance(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ColoredCoinsAssetTransfer extends AbstractAttachment {
        ...
        ColoredCoinsAssetTransfer(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class DigitalGoodsListing extends AbstractAttachment {
        ...
        DigitalGoodsListing(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
    ...
    class DigitalGoodsDelivery extends AbstractAttachment {
        ...
        DigitalGoodsDelivery(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class UnencryptedDigitalGoodsDelivery extends DigitalGoodsDelivery implements Encryptable {
        ...
        void putMyBytes(ByteBuffer buffer) {
            if (getGoods() == null) {
                throw new HebeException.NotYetEncryptedException("Goods not yet encrypted");
            }
    ...
    final class MonetarySystemCurrencyIssuance extends AbstractAttachment {
        ...
        MonetarySystemCurrencyIssuance(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ShufflingRecipients extends AbstractShufflingAttachment {
        ...
        ShufflingRecipients(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
            int count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count < 0) {
                throw new HebeException.NotValidException("Invalid data count " + count);
            }
    ...
    final class ShufflingCancellation extends AbstractShufflingAttachment {
        ...
        ShufflingCancellation(ByteBuffer buffer, byte transactionVersion) throws HebeException.NotValidException {
            super(buffer, transactionVersion);
            int count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count <= 0) {
                throw new HebeException.NotValidException("Invalid data count " + count);
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (size > Constants.MAX_PAYLOAD_LENGTH) {
                    throw new HebeException.NotValidException("Invalid data size " + size);
                }
            ...
            count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count <= 0) {
                throw new HebeException.NotValidException("Invalid keySeeds count " + count);
            }
    ...
    final class TaggedDataUpload extends TaggedDataAttachment {
        ...
        public TaggedDataUpload(String name, String description, String tags, String type, String channel, boolean isText,
                                String filename, byte[] data) throws HebeException.NotValidException {
            ...
            if (isText && !Arrays.equals(data, Convert.toBytes(Convert.toString(data)))) {
                throw new HebeException.NotValidException("Data is not UTF-8 text");
            }
        }
