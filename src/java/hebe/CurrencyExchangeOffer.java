...
public abstract class CurrencyExchangeOffer {
    ...
    static void exchangeCurrencyForHEBE(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    static void exchangeHEBEForCurrency(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    CurrencyExchangeOffer(long id, long currencyId, long accountId, long rateNQT, long limit, long supply,
        ...
        this.creationHeight = HEBE.getBlockchain().getHeight();
