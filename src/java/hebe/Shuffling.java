...
import hebe.crypto.AnonymouslyEncryptedData;
...
public final class Shuffling {
    ...
    private static final boolean deleteFinished = HEBE.getBooleanProperty("hebe.deleteFinishedShufflings");
    ...
    private void cancel(Block block) {
        ...
        if (blamedAccountId != 0) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Logger.logDebugMessage("Shuffling penalty %f HEBE awarded to forger at height %d", ((double)fee) / Constants.ONE_HEBE, block.getHeight() - i - 1);
            }
            ...
            Logger.logDebugMessage("Shuffling penalty %f HEBE awarded to forger at height %d", ((double)fee) / Constants.ONE_HEBE, block.getHeight());
        }
