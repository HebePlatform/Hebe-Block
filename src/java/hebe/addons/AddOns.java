...
import hebe.HEBE;
import hebe.http.APIServlet;
import hebe.http.APITag;
...
public final class AddOns {
    ...
    static {
        ...
        HEBE.getStringListProperty("hebe.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !HEBE.getBooleanProperty("hebe.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", HEBE.isDesktopApplicationEnabled() ? "hebedesktop.policy" : "hebe.policy");
