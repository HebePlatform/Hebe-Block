    ...
    JSONStreamAware processRequest(JSONObject request, Peer peer) {
        ...
        try {
            ...
            if (lastBlockIdString != null) {
                ...
                long myLastBlockId = HEBE.getBlockchain().getLastBlock().getId();
                if (myLastBlockId == lastBlockId || HEBE.getBlockchain().hasBlock(lastBlockId)) {
            ...
            if (lastMilestoneBlockIdString != null) {
                Block lastMilestoneBlock = HEBE.getBlockchain().getBlock(Convert.parseUnsignedLong(lastMilestoneBlockIdString));
            ...
            blockId = HEBE.getBlockchain().getBlockIdAtHeight(height);
