...
import static hebe.user.JSONResponses.DENY_ACCESS;
import static hebe.user.JSONResponses.INCORRECT_REQUEST;
import static hebe.user.JSONResponses.POST_REQUIRED;
...
public final class UserServlet extends HttpServlet  {
    ...
    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws HebeException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = HEBE.getBooleanProperty("hebe.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|HebeException e) {
