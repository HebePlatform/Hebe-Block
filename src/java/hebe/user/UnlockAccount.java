...
import static hebe.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Transaction> transactions = HEBE.getTransactionProcessor().getAllUnconfirmedTransactions()) {
            ...
            int blockchainHeight = HEBE.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = HEBE.getBlockchain().getBlocks(accountId, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = HEBE.getBlockchain().getTransactions(accountId, (byte) -1, (byte) -1, 0, false)) {
