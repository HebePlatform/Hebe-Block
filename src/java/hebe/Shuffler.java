...
public final class Shuffler {
    ...
    private static final int MAX_SHUFFLERS = HEBE.getIntProperty("hebe.maxNumberOfShufflers");
    ...
    private static void scheduleExpiration(Shuffling shuffling) {
        int expirationHeight = HEBE.getBlockchain().getHeight() + 720;
    ...
    private volatile HebeException.NotCurrentlyValidException failureCause;
    ...
    public HebeException.NotCurrentlyValidException getFailureCause() {
        return failureCause;
    }
    ...
    private void submitTransaction(Attachment.ShufflingAttachment attachment) {
        ...
        try {
            Transaction.Builder builder = HEBE.newTransactionBuilder(Crypto.getPublicKey(secretPhrase), 0, 0,
                    (short) 1440, attachment);
            builder.timestamp(HEBE.getBlockchain().getLastBlockTimestamp());
            ...
            if (participantAccount == null || transaction.getFeeNQT() > participantAccount.getUnconfirmedBalanceNQT()) {
                ...
                failureCause = new HebeException.NotCurrentlyValidException("Insufficient balance");
    ...
    public static class ShufflerException extends HebeException {
