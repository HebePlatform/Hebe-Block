...
public final class PhasingPoll extends AbstractPoll {
    ...
    public static DbIterator<TransactionImpl> getHoldihebehasedTransactions(long holdingId, VoteWeighting.VotingModel votingModel,
    ...
    public long countVotes() {
        ...
        int height = Math.min(this.finishHeight, HEBE.getBlockchain().getHeight());
