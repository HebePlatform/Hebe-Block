...
public interface TransactionProcessor extends Observable<List<? extends Transaction>,TransactionProcessor.Event> {
    ...
    void broadcast(Transaction transaction) throws HebeException.ValidationException;

    void processPeerTransactions(JSONObject request) throws HebeException.ValidationException;
    ...
    List<Transaction> restorePrunableData(JSONArray transactions) throws HebeException.NotValidException;
}
