...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws HebeException.NotValidException;

        Transaction build(String secretPhrase) throws HebeException.NotValidException;
    ...
    void validate() throws HebeException.ValidationException;
