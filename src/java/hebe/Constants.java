...
public final class Constants {
    ...
    public static final long MAX_BALANCE_HEBE = 1000000000;
//    public static final long MAX_BALANCE_HEBE = 1000000000;
    public static final long ONE_HEBE = 100000000;
    public static final long MAX_BALANCE_NQT = MAX_BALANCE_HEBE * ONE_HEBE;
//    public static final long INITIAL_BASE_TARGET = 153722867;
    public static final long INITIAL_BASE_TARGET = BigInteger.valueOf(2).pow(63).divide(BigInteger.valueOf(BLOCK_TIME * MAX_BALANCE_HEBE)).longValue(); //153722867;

    public static final long MAX_BASE_TARGET = MAX_BALANCE_HEBE * INITIAL_BASE_TARGET;
    public static final long MAX_BASE_TARGET_2 = isTestnet ? MAX_BASE_TARGET : INITIAL_BASE_TARGET * 50;
    public static final long MIN_BASE_TARGET = INITIAL_BASE_TARGET * 9 / 10;
    public static final int BASE_TARGET_GAMMA = 64;
    public static final int MAX_ROLLBACK = Math.max(HEBE.getIntProperty("hebe.maxRollback"), 720);
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? HEBE.getIntProperty("hebe.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? HEBE.getIntProperty("hebe.testnetLeasingDelay", 1440) : 1440;
    public static final long MIN_FORGING_BALANCE_NQT = 1000 * ONE_HEBE;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = HEBE.getIntProperty("hebe.forgingDelay");
    public static final int FORGING_SPEEDUP = HEBE.getIntProperty("hebe.forgingSpeedup");
    ...
    static {
        int maxPrunableLifetime = HEBE.getIntProperty("hebe.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = HEBE.getBooleanProperty("hebe.includeExpiredPrunable");
    ...
    public static final byte MIN_NUMBER_OF_SHUFFLING_PARTICIPANTS = 30;
    public static final byte MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS = 60; // max possible at current block payload limit is 51
...
//    public static final int CHECKSUM_BLOCK_16 = isTestnet ? 450000 : 556000;
  //  public static final int SHUFFLING_BLOCK = isTestnet ? 483000 : 621000;
    public static final int SHUFFLING_BLOCK = isTestnet ? 483000 : 3;
...
//    public static final int CHECKSUM_BLOCK_20 = isTestnet ? 944000 : 0;
//    
//    public static final int CHECKSUM_BLOCK_21 = isTestnet ? 1051000 : 0;
    public static final int CHECKSUM_BLOCK_22 = isTestnet ? 1152000 : 0;
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_HEBE;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_HEBE;

    public static final boolean correctInvalidFees = HEBE.getBooleanProperty("hebe.correctInvalidFees");
