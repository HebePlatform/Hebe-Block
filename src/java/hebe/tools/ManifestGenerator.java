...
import hebe.HEBE;
import hebe.env.service.HebeService_ServiceManagement;

public class ManifestGenerator {

    public static void main(String[] args) {
        ManifestGenerator manifestGenerator = new ManifestGenerator();
        manifestGenerator.generate("./resource/hebe.manifest.mf", HEBE.class.getCanonicalName(), "./lib");
        String serviceClassName = HebeService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/hebeservice.manifest.mf", serviceClassName, "./lib");
    }
