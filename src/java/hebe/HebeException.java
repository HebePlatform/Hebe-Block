...
public abstract class HebeException extends Exception {

    protected HebeException() {
        super();
    }

    protected HebeException(String message) {
        super(message);
    }

    protected HebeException(String message, Throwable cause) {
        super(message, cause);
    }

    protected HebeException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends HebeException {
    ...
    public static final class HebeIOException extends IOException {

        public HebeIOException(String message) {
            super(message);
        }

        public HebeIOException(String message, Throwable cause) {
            super(message, cause);
        }
