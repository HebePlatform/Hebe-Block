...
public class UPnP {
    ...
    private static void init() {
        ...
        try {
            ...
            GatewayDevice.setHttpReadTimeout(HEBE.getIntProperty("hebe.upnpGatewayTimeout", GatewayDevice.getHttpReadTimeout()));
            GatewayDiscover discover = new GatewayDiscover();
            discover.setTimeout(HEBE.getIntProperty("hebe.upnpDiscoverTimeout", discover.getTimeout()));
