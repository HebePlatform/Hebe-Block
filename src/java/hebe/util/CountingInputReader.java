...
import hebe.HebeException.HebeIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  hebeIOException      Maximum count exceeded
     */
    private void incCount(long c) throws HebeIOException {
        count += c;
        if (count > limit)
            throw new HebeIOException("Maximum size exceeded: " + count);
    }
}
