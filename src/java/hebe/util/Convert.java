...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "HEBE-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws HebeException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new HebeException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseHEBE(String hebe) {
        return parseStringFraction(hebe, 8, Constants.MAX_BALANCE_HEBE);
    }
