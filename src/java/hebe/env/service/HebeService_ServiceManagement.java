 ...
 */
package hebe.env.service;

import javax.swing.*;

import hebe.HEBE;
import hebe.env.LookAndFeel;

@SuppressWarnings("UnusedDeclaration")
public class HebeService_ServiceManagement {
    ...
    public static String[] serviceGetInfo() {
        return new String[]{
                "HEBE Server", // Long name
                "Manages the HEBE cryptographic currency protocol", // Description
                "true", // IsAutomatic
                "true", // IsAcceptStop
                "", // failure exe
                "", // args failure
    ...
    public static boolean serviceIsCreate() {
        return JOptionPane.showConfirmDialog(null, "Do you want to install the HEBE service ?", "Create Service", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
    }
    ...
    public static boolean serviceIsDelete() {
        return JOptionPane.showConfirmDialog(null, "This HEBE service is already installed. Do you want to delete it ?", "Delete Service", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
    }
