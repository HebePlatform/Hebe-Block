...
public class DesktopApplication extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        webEngine.setUserDataDirectory(HEBE.getConfDir());
        ...
        loadWorker.stateProperty().addListener(
                (ov, oldState, newState) -> {
                    ...
                    stage.setTitle("HEBE Desktop - " + webEngine.getLocation());
                    nrs = (JSObject) webEngine.executeScript("NRS");
                    updateClientState("Desktop Wallet started");
                    BlockchainProcessor blockchainProcessor = HEBE.getBlockchainProcessor();
                    ...
                    HEBE.getTransactionProcessor().addListener((transaction) ->
        ...
        stage.getIcons().add(new Image(address + "/img/hebe-icon-32x32.png"));
    ...
    private static String getUrl() {
        ...
        String defaultAccount = HEBE.getStriheberoperty("hebe.defaultDesktopAccount");
