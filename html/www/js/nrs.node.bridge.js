const options = {
    url: "http://localhost:6876", // URL of HEBE remote node
...
exports.load = function(callback) {
    ...
    require("jsdom").env("", function(err, window) {
        try {
            ...
            // the HEBE client was note designed with modularity in mind there we have
            ...
            // Now load some HEBE specific libraries into the global scope
            global.HebeAddress = require('./util/hebeaddress');
            ...
            // however the HEBE client relies on a global browser scope which defines the NRS object
