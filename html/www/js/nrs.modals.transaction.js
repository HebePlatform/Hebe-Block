...
var NRS = (function (NRS, $, undefined) {
                                ...
                                if (!response.errorCode) {
                                    if (transaction.recipient != response.buyer || transaction.attachment.priceNQT != response.priceNQT) {
                                        ...
                                        message = $.t("alias_sale_direct_offer", {
                                            "hebe": NRS.formatAmount(transaction.attachment.priceNQT)
                            ...
                            if (transaction.attachment.asset) {
                                NRS.sendRequest("getAsset", {
                                    ...
                                    data = {
                                        ...
                                        "asset_name": asset.name,
                                        "quantity": [transaction.attachment.quantityQNT, asset.decimals],
                                        "price_formatted_html": NRS.formatOrderPricePerWholeQNT(transaction.attachment.priceNQT, asset.decimals) + " HEBE",
                                        "total_formatted_html": NRS.formatAmount(NRS.calculateOrderTotalNQT(transaction.attachment.quantityQNT, transaction.attachment.priceNQT)) + " HEBE"
                                    };
                                    data["sender"] = transaction.senderRS ? transaction.senderRS : transaction.sender;
                                    infoTable.find("tbody").append(NRS.createInfoTable(data));
                                    infoTable.show();
                            ...
                            if (transaction.attachment.asset) {
                                NRS.sendRequest("getAsset", {
                                    ...
                                    data = {
                                        ...
                                        "asset_formatted_html": NRS.getTransactionLink(transaction.attachment.asset),
                                        "asset_name": asset.name,
                                        "amount_per_share": NRS.formatOrderPricePerWholeQNT(transaction.attachment.amountNQTPerQNT, asset.decimals) + " HEBE",
                    ...
                    case 2:
                        ...
                        NRS.sendRequest("getDGSGood", {
                            ...
                            data = {
                                ...
                                "item_name": goods.name,
                                "new_price_formatted_html": NRS.formatAmount(transaction.attachment.priceNQT) + " HEBE",
                                "seller": NRS.getAccountFormatted(goods, "seller")
                            };
                        ...
                        NRS.sendRequest("getDGSPurchase", {
                            ...
                            NRS.sendRequest("getDGSGood", {
                                ...
                                if (purchase.quantity != "1") {
                                    ...
                                    data["total_formatted_html"] = orderTotal + " HEBE";
                                }
                    ...
                    case 7:
                        ...
                        NRS.sendRequest("getDGSPurchase", {
                            ...
                            NRS.sendRequest("getDGSGood", {
                                ...
                                data["order_total_formatted_html"] = NRS.formatAmount(orderTotal) + " HEBE";
                ...
                switch (transaction.subtype) {
                    case 0:
                        ...
                        data = {
                            ...
                            "min_reserve_per_unit_formatted_html": NRS.formatAmount(minReservePerUnitNQT) + " HEBE",
                        ...
                        if (currency) {
                            ...
                            data["current_reserve_per_unit_formatted_html"] = NRS.formatAmount(currentReservePerUnitNQT) + " HEBE";
                        } else {
                    ...
                    case 1:
                        if (currency) {
                            ...
                            data = {
                                ...
                                "amount_per_unit_formatted_html": NRS.formatAmount(amountPerUnitNQT) + " HEBE",
                                "reserved_amount_formatted_html": NRS.formatAmount(NRS.calculateOrderTotalNQT(amountPerUnitNQT, NRS.convertToQNTf(resSupply, currency.decimals))) + " HEBE"
                            };
                        } else {
                    ...
                    case 2:
                        if (currency) {
                            ...
                            data = {
                                ...
                                "claimed_amount_formatted_html": NRS.formatAmount(NRS.convertToQNTf(NRS.calculateOrderTotalNQT(reservePerUnitNQT, transaction.attachment.units), currency.decimals)) + " HEBE"
                            };
                        } else {
                            data = NRS.getUnknownCurrencyData(transaction);
                        }
    ...
    NRS.formatAssetOrder = function (asset, transaction, isModalVisible) {
        ...
        NRS.sendRequest("getOrderTrades", params, function (response) {
            ...
            data["total_traded"] = NRS.formatAmount(tradeTotal, false, true) + " HEBE";
        }, { isAsync: false });
    ...
    NRS.formatCurrencyExchange = function (currency, transaction, type) {
        var rateUnitsStr = " [ " + currency.code + " / HEBE ]";
        var data = {
        ...
        NRS.sendRequest("getExchangesByExchangeRequest", {
            ...
            data["total_exchanged"] = NRS.formatAmount(exchangedTotal, false, true) + " [HEBE]";
        }, { isAsync: false });
        return data;
    };
