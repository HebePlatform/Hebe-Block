...
var NRS = (function(NRS, $) {
    ...
    $("#add_monitored_account_modal").on("show.bs.modal", function() {
        ...
        $("#add_monitored_account_amount").val(NRS.convertToHEBE(currentMonitor.amount));
        $("#add_monitored_account_threshold").val(NRS.convertToHEBE(currentMonitor.threshold));
