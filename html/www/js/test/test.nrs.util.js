...
QUnit.test("convertToHEBE", function (assert) {
    assert.equal(NRS.convertToHEBE(200000000), "2", "whole");
    assert.equal(NRS.convertToHEBE(20000000), "0.2", "fraction");
    assert.equal(NRS.convertToHEBE(-200000000), "-2", "negative");
    assert.equal(NRS.convertToHEBE(-20000000), "-0.2", "fraction.negative");
    assert.equal(NRS.convertToHEBE(-220000000), "-2.2", "whole.fraction.negative");
    assert.equal(NRS.convertToHEBE(2), "0.00000002", "nqt");
    assert.equal(NRS.convertToHEBE(-2), "-0.00000002", "nqt.negative");
    assert.equal(NRS.convertToHEBE(new BigInteger(String(2))), "0.00000002", "input.object");
    assert.equal(NRS.convertToHEBE("hi"), "0.00000188", "alphanumeric"); // strange behavior of BigInteger don't do that
    assert.throws(function () {
        NRS.convertToHEBE(null);
    }, {
...
QUnit.test("formatAmount", function (assert) {
    ...
    assert.equal(NRS.formatAmount("123456700000000", true, true), Number("1234567").toLocaleString(), "hebe.rounding");
...
QUnit.test("getAccountLink", function (assert) {
    ...
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831 }, "entity"), "<a href='#' data-user='HEBE-XKA2-7VJU-VZSY-7R335' class='show_account_modal_action user-info'>/</a>", "numeric");
    assert.equal(NRS.getAccountLink({ entityRS: "HEBE-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='HEBE-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>HEBE-XK4R-7VJU-6EQG-7R335</a>", "RS");
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831, entityRS: "HEBE-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='HEBE-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>HEBE-XK4R-7VJU-6EQG-7R335</a>", "numeric.and.RS");
    NRS.contacts = { "HEBE-XK4R-7VJU-6EQG-7R335": { name: "foo" }};
    assert.equal(NRS.getAccountLink({ entityRS: "HEBE-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='HEBE-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>foo</a>", "contact");
    NRS.accountRS = "HEBE-XK4R-7VJU-6EQG-7R335";
    assert.equal(NRS.getAccountLink({ entityRS: "HEBE-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='HEBE-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>You</a>", "you");
    assert.equal(NRS.getAccountLink({ entityRS: "HEBE-XK4R-7VJU-6EQG-7R335" }, "entity", "HEBE-XK4R-7VJU-6EQG-7R335", "account"), "<a href='#' data-user='HEBE-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>Account</a>", "force.account.name");
    assert.equal(NRS.getAccountLink({ entityRS: "HEBE-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, true), "<a href='#' data-user='HEBE-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>HEBE-XK4R-7VJU-6EQG-7R335</a>", "maintain.rs.format");
    assert.equal(NRS.getAccountLink({ entityRS: "HEBE-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, undefined, "btn btn-xs"), "<a href='#' data-user='HEBE-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info btn btn-xs'>You</a>", "add.class");
    NRS.contacts = null;
    NRS.accountRS = null;
    NRS.constants.GENESIS = 1739068987193023818;
    NRS.constants.GENESIS_RS = "HEBE-MR8N-2YLS-3MEQ-3CMAJ";
    assert.equal(NRS.getAccountLink({ entityRS: NRS.constants.GENESIS_RS }, "entity"), "<a href='#' data-user='HEBE-MR8N-2YLS-3MEQ-3CMAJ' class='show_account_modal_action user-info'>Genesis</a>", "genesis");
});

QUnit.test("generateToken", function (assert) {
    NRS.constants.EPOCH_BEGINNING = 1492646400000;
