...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount HEBE",
			labelI18n: "amount_hebe",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumHEBE",
			addonText: "HEBE",
			addonI18n: "hebe_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_hebe', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceHEBE';
		context['addonText'] = 'HEBE';
		context['addonI18n'] = 'hebe_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_hebe', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
