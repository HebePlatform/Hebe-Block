...
/*
    HEBE address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: HebeChg (admin@hebechg.com).
*/

function HebeAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('HEBE-') == 0) adr = adr.substr(4);
