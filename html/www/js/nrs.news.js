	...
	NRS.pages.news = function() {
      ...
      var settingsReddit = {
         ...
         "filter": function(entry, tokens) {
            return tokens.title.indexOf("Donations toward") == -1 && tokens.title.indexOf("HEBE tipping bot has arrived") == -1
         },
         "ssl": ssl
      };

      $("#hebeforum_news").rss("https://hebeforum.org/index.php?type=rss;action=.xml", settings, NRS.newsLoaded);
      $("#reddit_news").rss("http://www.reddit.com/r/HEBE/.rss", settingsReddit, NRS.newsLoaded);
      $("#hebecoin_blogspot_news").rss("http://hebecoin.blogspot.com/feeds/posts/default", settings, NRS.newsLoaded);
      $("#hebeer_news").rss("http://hebeer.org/feed/", settings, NRS.newsLoaded);
		NRS.pageLoaded();
	};
