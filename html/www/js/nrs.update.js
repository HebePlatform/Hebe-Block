...
var NRS = (function(NRS, $) {
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "hebe-client-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "hebe-client-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "hebe-client-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "hebe-client-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "hebe-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "hebe-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "hebe-client-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "hebe-client-", ext: "sh"}
	];
	...
	NRS.downloadClientUpdate = function(status, ext) {
        ...
        var fileurl = "https://github.com/HebePlatform/Hebe-Block/releases/download" + filename;
