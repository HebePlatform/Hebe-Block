...
to your client system including your Hebe passphrase.

Make sure to only run plugins downloaded from trusted sources, otherwise
you can lose your HEBE! In doubt don't log into the client with an account
used to store large amount of HEBE now or in the future while plugins
are active.
